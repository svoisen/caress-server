...
function Caress(host, port, options) {
  ...
  var tuioUdpSocket = this.tuioUdpSocket = dgram.createSocket("udp4");
  ...
  var tuioTcpSocket = this.tuioTcpSocket = net.createServer(function(socket){
...
Caress.prototype.close = function() {
  this.tuioTcpSocket.close(function() {
    console.log("TUIO TCP Server closed");
  });

  this.tuioUdpSocket.close(function() {
    console.log("TUIO UDP Server closed");
  })
};
